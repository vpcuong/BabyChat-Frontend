  ...
  return (
    <div>
      ...
      <section style={{ padding: '48px 0', textAlign: 'center' }}>
        ...
        <Paragraph style={{ fontSize: 16, color: token.colorTextSecondary, maxWidth: 720, margin: '0 auto 40px' }}>
        ...
        <Row justify="center" gutter={[48, 24]}>
          <Col><Statistic title="Active Users" value="1M+" styles={{ content: { color: token.colorPrimary } }} /></Col>
          <Col><Statistic title="Countries"    value="150+"  styles={{ content: { color: token.colorPrimary } }} /></Col>
          <Col><Statistic title="Support"      value="24/7"  styles={{ content: { color: token.colorPrimary } }} /></Col>
        </Row>
      </section>
      ...
      {/* CTA */}
      <section style={{ padding: '48px 0', textAlign: 'center', background: token.colorPrimary, borderRadius: 16, marginBottom: 32 }}>
